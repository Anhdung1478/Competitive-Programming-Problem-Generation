...
(<https://github.com/LLaammTTeerr/competitive-programming>), whose bundled Polygon
MCP server this package descends from. Reused with attribution; the
divergences from it live in `server.py` and `config.py`, not here.
